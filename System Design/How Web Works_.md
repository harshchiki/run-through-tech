...
What happens behind the scenes when we type [google.com](http://google.com/) in a browser?
...
- [Check HSTS list](https://github.com/vasanthk/how-web-works#check-hsts-list)
...
[![](../_resources/1aff039b212949a8cc4087e4ee7d651e.png)](https://camo.githubusercontent.)

One worrying thing about DNS is that the entire domain like [wikipedia.org](http://wikipedia.org/) or [facebook.com](http://facebook.com/) seems to map to a single IP address. Fortunately, there are ways of mitigating the bottleneck:

- **Round-robin DNS** is a solution where the DNS lookup returns multiple IP addresses, rather than just one. For example, [facebook.com](http://facebook.com/) actually maps to four IP addresses.
...
- The server breaks down the request to the following parameters:
    ...
    - Domain, in this case - [google.com](http://google.com/).
    - Requested path/page, in this case - / (as no specific path/page was requested, / is the default path).
    - The server verifies that there is a Virtual Host configured on the server that corresponds with [google.com](http://google.com/).
- The server verifies that [google.com](http://google.com/) can accept GET requests.
...
- The server parses the file according to the request handler. A request handler is a program (in [ASP.NET](http://asp.net/), PHP, Ruby, …) that reads the request and generates the HTML for the response. If Google is running on PHP, the server uses PHP to interpret the index file, and streams the output to the client.
...
[![](../_resources/7ba7cd1c25f87aa6bacc9cc57edd9689.png)](https://camo.githubusercontent.com/60021daaab40d78bdf6d3b027a963aaeb953aeed/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f6c61796572732e706e67)
...
[![](../_resources/ad6ebc3fa910f6637ef3239119e59e19.png)](https://camo.githubusercontent.)
...
[![](../_resources/8d6033311bb4ebc11180b97681e03afc.png)](https://camo.githubusercontent.)
...
[![](../_resources/71f429bba5ef6fb7bd2221f8082ba20a.png)](https://camo.githubusercontent.com/08c0c53d4cb12a0b439cde71b4fe815fdc99807d/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f666c6f772e706e67)
...
[![](../_resources/85a66640e7f1d9b94421884d454cad12.png)](https://camo.githubusercontent.com/c45bb5ddecd284a400417b01ee2d4debf80007df/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f7765626b6974666c6f772e706e67)
...
[![](../_resources/175e3c1dd7246701c39c7ad7f841ddc4.png)](https://camo.githubusercontent.com/b31f5d7278665d2f300424a58eabffe9f49bf10e/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f696d6167653031312e706e67)
...
[![](../_resources/618a32b45bea0ca79c36309579c8dedb.png)](https://camo.githubusercontent.com/1e824f2d50c8c0e05584449081250e81e9f2aa63/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f696d6167653031372e706e67)
...
[![](../_resources/16ef855a130014986eef5af91304b3a0.png)](https://camo.githubusercontent.com/1ea11f29843617b8069602880576f38c7d731a32/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f696d6167653031352e706e67)
...
[![](../_resources/a43a99a924a135f54b9ccd937b6c5de5.png)](https://camo.githubusercontent.com/385d96b819aeade8f1293d5a1f612007c8046b4b/687474703a2f2f7777772e68746d6c35726f636b732e636f6d2f656e2f7475746f7269616c732f696e7465726e616c732f686f7762726f7773657273776f726b2f696d6167653032352e706e67)
